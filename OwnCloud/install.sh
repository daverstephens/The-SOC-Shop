...
sudo apt-get install apache2 mysql-server sendmail-bin php php-bz2 php-curl php-gd php-imagick php-intl php-mbstring php-xml php-zip libapache2-mod-php php-mcrypt php-mysql php-imap php-ssh2 clamav clamav-daemon php-gmp
cd /var/www/html
